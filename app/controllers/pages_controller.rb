...
def dashboard
  ...
  response = HTTParty.get "https://api.fitbit.com/1/user/#{@user.fitbit_credential.uid}/activities/heart/date/#{yesterday}/today.json", headers: {"Authorization" => "Bearer #{@user.fitbit_credential.token}"}
