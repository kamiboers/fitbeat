Rails.application.config.middleware.use OmniAuth::Builder do
  ...
  provider :fitbit_oauth2, ENV['FITBIT_ID'], ENV['FITBIT_KEY'], response_type: 'code', scope: 'activity heartrate profile location nutrition settings sleep social', redirect_uri: 'http://localhost:8080/auth/fitbit_oauth2/callback'
